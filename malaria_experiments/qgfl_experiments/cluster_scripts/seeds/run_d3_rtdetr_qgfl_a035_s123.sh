#!/bin/bash
#SBATCH --job-name=rtdetr_d3_qgfl_a035_s123
#SBATCH --gres=gpu:1
#SBATCH --mem=64000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/rtdetr_d3_qgfl_a035_s123_%j.out
#SBATCH --error=logs/rtdetr_d3_qgfl_a035_s123_%j.err
...
echo "Job: RT-DETR + QGFL Alpha 0.35 on D3 (Multi-species, Seed 123)"
