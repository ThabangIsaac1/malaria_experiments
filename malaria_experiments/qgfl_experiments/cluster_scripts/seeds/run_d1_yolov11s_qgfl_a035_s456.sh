#!/bin/bash
#SBATCH --job-name=yolo_v11s_d1_qgfl_a035_s456
#SBATCH --gres=gpu:1
#SBATCH --mem=32000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/yolo_v11s_d1_qgfl_a035_s456_%j.out
#SBATCH --error=logs/yolo_v11s_d1_qgfl_a035_s456_%j.err
...
echo "Job: YOLOv11s + QGFL Alpha 0.35 on D1 (Seed 456)"
