#!/bin/bash
#SBATCH --job-name=rtdetr_species_base_s042
#SBATCH --gres=gpu:1
#SBATCH --mem=64000
#SBATCH --cpus-per-task=8
#SBATCH --output=logs/species/rtdetr_base_s042_%j.out
#SBATCH --error=logs/species/rtdetr_base_s042_%j.err
...
echo "========================================"
echo "Species Baseline: RT-DETR (Seed 42)"
