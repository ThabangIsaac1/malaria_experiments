#!/bin/bash
#SBATCH --job-name=yolo8s_saqgfl_s042
#SBATCH --gres=gpu:1
#SBATCH --mem=64000
#SBATCH --cpus-per-task=8
#SBATCH --output=logs/species/yolo8s_saqgfl_s042_%j.out
#SBATCH --error=logs/species/yolo8s_saqgfl_s042_%j.err
