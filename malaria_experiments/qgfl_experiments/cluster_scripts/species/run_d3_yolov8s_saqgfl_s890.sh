#!/bin/bash
#SBATCH --job-name=yolo8s_saqgfl_s890
#SBATCH --gres=gpu:1
#SBATCH --mem=64000
#SBATCH --cpus-per-task=8
#SBATCH --output=logs/species/yolo8s_saqgfl_s890_%j.out
#SBATCH --error=logs/species/yolo8s_saqgfl_s890_%j.err
