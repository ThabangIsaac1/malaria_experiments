#!/bin/bash
#SBATCH --job-name=v11s_d3_qgfl_a035
#SBATCH --gres=gpu:1
#SBATCH --mem=32000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/v11s_d3_qgfl_a035_%j.out
#SBATCH --error=logs/v11s_d3_qgfl_a035_%j.err
...
echo "Job: YOLOv11s + QGFL Sweet Spot on D3"
