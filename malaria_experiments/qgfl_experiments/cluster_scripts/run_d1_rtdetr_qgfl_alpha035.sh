#!/bin/bash
#SBATCH --job-name=rtdetr_d1_qgfl_a035
#SBATCH --gres=gpu:1
#SBATCH --mem=32000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/rtdetr_d1_qgfl_a035_%j.out
#SBATCH --error=logs/rtdetr_d1_qgfl_a035_%j.err
...
echo "Job: RT-DETR + QGFL Sweet Spot on D1"
