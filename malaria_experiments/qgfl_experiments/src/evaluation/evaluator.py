...
class ComprehensiveEvaluator:
    ...
    def compute_error_analysis(self, split):
        ...
        img_files = list(img_dir.glob('*.jpg'))[:100]  # Sample for error analysis
    ...
    def compute_confusion_matrix(self, split):
        ...
        for img_path in tqdm(img_files[:100], desc="Building confusion matrix"):
            label_path = lbl_dir / (img_path.stem + '.txt')
    ...
    def _calculate_ap(self, precision, recall):
        ...
        for t in np.arange(0, 1.1, 0.1):
            ...
            ap += p / 11
        return ap# src/evaluation/evaluator.py
import numpy as np
import pandas as pd
from pathlib import Path
from collections import defaultdict
